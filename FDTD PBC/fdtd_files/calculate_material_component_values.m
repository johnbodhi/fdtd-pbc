...
eps_r_x(1:nx,1,2:nz) = 0.5 * (t_eps_r(material_3d_space(1:nx,1,2:nz)) ...
                        + t_eps_r(material_3d_space(1:nx,1,1:nz-1)));
                    
eps_r_x(1:nx,nyp1,2:nz) = 0.5 * (t_eps_r(material_3d_space(1:nx,ny,2:nz)) ...
                        + t_eps_r(material_3d_space(1:nx,ny,1:nz-1)));
...
eps_r_y(1,1:ny,2:nz) = 0.5 * (t_eps_r(material_3d_space(1,1:ny,2:nz)) ...
                        + t_eps_r(material_3d_space(1,1:ny,1:nz-1)));
                    
eps_r_y(nxp1,1:ny,2:nz) = 0.5 * (t_eps_r(material_3d_space(nx,1:ny,2:nz)) ...
...
eps_r_z(1,1:ny,1:nz)    = t_eps_r(material_3d_space(1,1:ny,1:nz)); 
eps_r_z(nxp1,1:ny,1:nz) = t_eps_r(material_3d_space(nx,1:ny,1:nz));
eps_r_z(1:nx,1,1:nz)    = t_eps_r(material_3d_space(1:nx,1,1:nz));
eps_r_z(1:nx,nyp1,1:nz) = t_eps_r(material_3d_space(1:nx,ny,1:nz));
eps_r_z(nxp1,nyp1,1:nz) = t_eps_r(material_3d_space(nx,ny,1:nz));
...
sigma_e_x(1:nx,1,2:nz) = 0.5 * (t_sigma_e(material_3d_space(1:nx,1,2:nz)) ...
                        + t_sigma_e(material_3d_space(1:nx,1,1:nz-1)));
                    
sigma_e_x(1:nx,nyp1,2:nz) = 0.5 * (t_sigma_e(material_3d_space(1:nx,ny,2:nz)) ...
                        + t_sigma_e(material_3d_space(1:nx,ny,1:nz-1)));
...
sigma_e_y(1,1:ny,2:nz) = 0.5 * (t_sigma_e(material_3d_space(1,1:ny,2:nz)) ...
                        + t_sigma_e(material_3d_space(1,1:ny,1:nz-1)));
                    
sigma_e_y(nxp1,1:ny,2:nz) = 0.5 * (t_sigma_e(material_3d_space(nx,1:ny,2:nz)) ...
                        + t_sigma_e(material_3d_space(nx,1:ny,1:nz-1)));
...
sigma_e_z(1,1:ny,1:nz)    = t_sigma_e(material_3d_space(1,1:ny,1:nz)); 
sigma_e_z(nxp1,1:ny,1:nz) = t_sigma_e(material_3d_space(nx,1:ny,1:nz));
sigma_e_z(1:nx,1,1:nz)    = t_sigma_e(material_3d_space(1:nx,1,1:nz));
sigma_e_z(1:nx,nyp1,1:nz) = t_sigma_e(material_3d_space(1:nx,ny,1:nz));
sigma_e_z(nxp1,nyp1,1:nz) = t_sigma_e(material_3d_space(nx,ny,1:nz));
...
mu_r_x(1,1:ny,1:nz) = t_mu_r(material_3d_space(1,1:ny,1:nz));
mu_r_x(nxp1,1:ny,1:nz) = t_mu_r(material_3d_space(nx,1:ny,1:nz));
...
mu_r_y(1:nx,1,1:nz) = t_mu_r(material_3d_space(1:nx,1,1:nz));
mu_r_y(1:nx,nyp1,1:nz) = t_mu_r(material_3d_space(1:nx,ny,1:nz));
...
mu_r_z(1:nx,1:ny,1) = t_mu_r(material_3d_space(1:nx,1:ny,1));
mu_r_z(1:nx,1:ny,nzp1) = t_mu_r(material_3d_space(1:nx,1:ny,nz));
...
sigma_m_x(1,1:ny,1:nz) = t_sigma_m(material_3d_space(1,1:ny,1:nz));
sigma_m_x(nxp1,1:ny,1:nz) = t_sigma_m(material_3d_space(nx,1:ny,1:nz));
...
sigma_m_y(1:nx,1,1:nz) = t_sigma_m(material_3d_space(1:nx,1,1:nz));
sigma_m_y(1:nx,nyp1,1:nz) = t_sigma_m(material_3d_space(1:nx,ny,1:nz));
...
sigma_m_z(1:nx,1:ny,1) = t_sigma_m(material_3d_space(1:nx,1:ny,1));
sigma_m_z(1:nx,1:ny,nzp1) = t_sigma_m(material_3d_space(1:nx,1:ny,nz));
